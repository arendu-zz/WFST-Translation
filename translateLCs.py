...
if __name__ == '__main__':
    ...
    for idx,s in enumerate(open(input_file,'r').readlines()):
        ...
        os.system('fstshortestpath -nshortest=1000 t/lc.trans.fst > t/lc.short.trans.fst')
        ...
        os.system('fstshortestpath -nshortest=1000 t/lc.s.s.out.fst > t/lc.s.s.short.out.fst')
        ...
        os.system('cp t/lc'+str(idx)+'.final.fst lcs-out/lc'+str(idx)+'.final.fst')
        os.system('rm -rf t')
