...
if __name__ == '__main__':
    ...
    for s in open(input_file, 'r').readlines():
        ...
        os.system('fstcompose t2/lc.s.s.out.sorted.fst data/unk.fst > t2/lc.unk.unsorted.fst')
        os.system('fstarcsort --sort_type="olabel" t2/lc.unk.unsorted.fst > t2/lc.unk.fst')
